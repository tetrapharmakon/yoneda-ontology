...
\begin{itemize}
  \item for the definition of category, functor, and natural transformation, in \cite[]{}, \cite[]{}, \cite[]{}, \cite[]{}, \cite[]{}.
  \item For the definition of co/limit and adjunction, in \cite[]{}, \cite[]{}, \cite[]{}, \cite[]{}.
  \item For the definition of accessible and locally presentable category in \cite[]{}, \cite[]{}, \cite[]{}, \cite[]{}.
  \item Basic facts about ordinal and cardnal numbers can be found in \cite[]{}; a comprehensive reference on basic and non-basic set theory is \cite{jech2013set}.
  ...
  \item Standard references for topos theory are \cite{mac1992sheaves,JohnstonePT}.
\end{itemize}

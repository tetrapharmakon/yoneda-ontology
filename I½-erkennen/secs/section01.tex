...
\begin{definition}[Wiener Circle theory] \cite{krause-foundation}
	...
	\begin{itemize}
	\item {\color{blue!30}A formal language $\clF_\clL$ whose a non-logical vocabulary $\overline{\clV}$ is divided in two sub-vocabularies: $\clT$ for theoretical terms and $\clO$ for observational terms \footnote{Non sono ammesse restrizioni sul linguaggio in questo approccio, e questo implica che 
	\begin{quotation}
	...
	\end{quotation}}.}
	\item {\color{blue!30} A logical vocabulary, namely a set of logical axioms with derivation rules and a notion of consequence relation, called $\clV$. So $\clF_\clL= \clV \cup \overline{\clV}$.}

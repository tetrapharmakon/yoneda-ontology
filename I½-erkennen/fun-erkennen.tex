...
\begin{example}
 Every functor $F : \clA \to \clB$ gives rise to a profunctor $F_*$ and a profunctor $F^*$; the two functors are mutually adjoint. This defines \emph{representable} Ramsey maps. \foo{Say more; also, why (1,1)-ary? Wait and see}
\end{example}

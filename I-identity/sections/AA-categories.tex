...
\begin{itemize}
	...
	\item Basic facts about ordinal and cardinal numbers can be found in \cite{kunen}; a comprehensive reference on basic and non-basic set theory is \cite{jech2013set}.
...
\begin{theorem}
	...
	\begin{itemize}
		\item the category of Lawvere theories, regarded as a non-full subcategory of the category $\textsf{Fin}^\op/\Cat$, i.e. where a morphism of Lawvere theories consists of a functor $h : \clL \to \clM$ that preserves finite products;

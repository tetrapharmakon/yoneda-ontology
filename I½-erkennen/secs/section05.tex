...
More is true: significa che c'è un modo categoriale di dire "se (p -> q) nel modello, allora [P] -> [Q] nel mondo", dove [P] e [Q] corrispondono nel mondo a quel che p e q sono nel linguaggio

Se un calcolo afferma che una palla di cannone seguirà un moto parabolico, allora questo è quello che effettivamente osservo nel mondo, sebbene nel mondo non ci siano le parabole (che sono un'astrazione linguistica di una media di ricorrenze percettive)

Queste ipotesi implicano che "l'ermeneutica è possibile". Proprio perché puoi interpretare i fatti linguistici e le derivazioni in un sistema deduttivo come effettive implicazioni all'interno del mondo
\color{black}
\begin{remark}

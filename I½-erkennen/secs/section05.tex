...
} \label{2_canvases}\] gives rise, according to \autoref{}, to representations 
\[ \xymatrix{
	[\clO^\op,\Set] \ar[r]^-{N_\psi} & \clW & \ar[l]_-{N_\phi} [\clT^\op,\Set]
} \label{2_reps}\]
...
We end the section with an important remark that shows how new structure comes `almost for free' when things are interpreted this way.

...
In some of our proofs it will be crucial to blur the distinction between the category of functors $I \to \Set$ and the slice category $\Set/I$ (see \autoref{}); once the following result is proved, we freely refer to any of these two categories as the category of \emph{variable sets} (indexed by $I$).
...
\end{proposition}
\begin{proof}
	We shall first show that the category of variable sets admits products: this is obvious in $\Set/I$, products are precisely pullbacks; note that theorem \autoref{} gives an identification
...
\end{proposition}
\begin{proof}
	Recall from \autoref{} that we shall find a variable set $\Omega$ such that there is a bijection
	\[\begin{array}{c}

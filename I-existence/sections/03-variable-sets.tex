\section{Preliminaries on variable set theory}\label{sec_prelim}
\epigraph
{{\dn  a\326wy\3C4wAdFEn \8{B}tAEn \326wy\3C4wm@yAEn BArt . \\
...
\end{remark}
The following results pertain to the classical literature on topos theory.

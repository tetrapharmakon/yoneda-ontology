...
Before delving into this generalisation, however, a more elementary remark is in order: there is a particularly elementary recipe to generate $(1,1)$-ary Ramsey maps.
\begin{example}
...
\end{example}
\begin{definition}[Observational and theoretical nucleus]
...
\begin{remark}\label{resoudre_la_tension}
	{\color{red} Qui spiegare che dato un profuntore da osserv a theoret. la costruzione degli elementi esibisce una categoria dove osserv. e theoret. vivono ``come in un corpo di tigre o di toro, nel quale pullulano mostruosamente, uniti e odiandosi, denti, organi e teste''}
\end{remark}

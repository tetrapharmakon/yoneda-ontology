...
For our objectives it's enough to declare a differentiation that Kr\"omer elaborate, inspired by \cite{Cor96}: the difference between \emph{structuralism} and \emph{structural mathematics}:
\begin{enumtag}{s}
